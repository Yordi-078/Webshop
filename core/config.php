...
define('DB_NAME', 'webshop'); // Wat is de database naam
define('DB_USER', 'Yordi'); 		// Wat is de database gebruiker
define('DB_PASS', 'Dordrecht01!');		// Wat is het database wachtwoord
